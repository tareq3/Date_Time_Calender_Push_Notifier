/*
 * Created by Tareq Islam on 7/7/18 8:12 PM
 *
 *  Last modified 7/7/18 8:12 PM
 */
...
public class AsyncSetNotification extends AsyncTask<String,String,String> {
    ...
    public AsyncSetNotification(Context context) {
        mContext = context;
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            url = new URL("http://192.168.0.108/FcmExample/SetNotification.php");
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    .appendQueryParameter("n_title", params[0])
                    .appendQueryParameter("n_calender", params[1])
    ...
    protected void onPostExecute(String result) {
       // super.onPostExecute(s);
        ...
        if(result.equalsIgnoreCase("true")|| result.equals("0") ) {
            ...
            Toast.makeText(mContext, "Notification has been set successfully", Toast.LENGTH_LONG).show();
        }else if(result.equals("2")){
            Toast.makeText(mContext, "your device not registered yet!", Toast.LENGTH_SHORT).show();
